        ...
        <div className="container">
            ...
            <form onSubmit={handleSubmit}>
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" id="inveType" name="inveType" value={formData.inveType} onChange={handleInputChange} required />
                </div>
                <div className="form-group">
                    <label htmlFor="proName">Product Name:</label>
                    <input type="text" className="form-control" id="proName" name="proName" value={formData.proName} onChange={handleInputChange} required />
                </div>
                <div className="form-group">
                    <label htmlFor="exDate">Expire Date:</label>
                    <input type="date" className="form-control" id="exDate" name="exDate" value={formData.exDate} onChange={handleInputChange} required />
                </div>
                <div className="form-group">
                ...
                <button className="sutnn" type="submit"></button>
                </form>
                </div>
                    )
                  }
