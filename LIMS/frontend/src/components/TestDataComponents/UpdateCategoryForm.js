...
const UpdateCategoryForm = ({subCategory}) => {
    const [categoryHeading, setCategoryHeading] = useState(subCategory.categoryHeading)
    ...
    const handleUpdate = async (e) => {
        ...
        const newCategory = {categoryHeading, category, UOM, startMRef, operatorM, endMRef, startFRef, operatorF, endFRef, startBRef, operatorB, endBRef}
